...
export function AppLayout({ children, title }) {
  ...
  return (
    <div className="flex min-h-svh flex-col bg-gradient-to-br from-background via-secondary/50 to-background text-foreground relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col flex-1 h-full w-full">
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto pb-16 md:pb-0 animate-fade-in">{children}</main>
        <BottomNav />
      </div>
    </div>
  )
